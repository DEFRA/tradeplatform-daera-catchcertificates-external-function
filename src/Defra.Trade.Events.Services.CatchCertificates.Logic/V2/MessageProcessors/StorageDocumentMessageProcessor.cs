...
public class StorageDocumentMessageProcessor(
    ...
    IMapper mapper) : BaseApiMessageProcessor<V2Inbound.StorageDocumentCreateInbound, TradeEventMessageHeader, V2Api.IMmoStorageDocumentApi, V2ApiModel.StorageDocument>(apiClient, logger, mapper)
{
