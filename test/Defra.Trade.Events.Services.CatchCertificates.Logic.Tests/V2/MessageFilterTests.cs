...
using Defra.Trade.Events.Services.CatchCertificates.Logic.V2;
using FluentAssertions;
using Xunit;

namespace Defra.Trade.Events.Services.CatchCertificates.Logic.Tests.V2;

public static class MessageFilterTests
{
    private static readonly string[] _allowedVersions = ["2"];
    ...
    private static readonly string[] _disallowedVersions = [null, "1", "", "abc"];
