...
using Defra.Trade.Events.Services.CatchCertificates.Logic.V3;
using FluentAssertions;
using Xunit;

namespace Defra.Trade.Events.Services.CatchCertificates.Logic.Tests.V3;

public static class MessageFilterTests
{
    private static readonly string[] _allowedVersions = ["3"];
